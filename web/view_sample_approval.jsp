...
<html>
  ...
  <tr>
    ...
    <td valign="top"><table id="admtab" width="100%" border="0" cellpadding="0" cellspacing="0">
      <!--DWLayoutTable-->
      <tr>
        <td id="heading_econf" height="69" colspan="8" valign="top"><h2>Sample Approval</h2></td>
        </tr>
      <tr>
      ...
      <tr>
        <td height="31"></td>
          <td colspan="2" valign="top"><label>Sample Tech Approval</label>&nbsp;</td>
          <td>&nbsp;</td>
      ...
      <tr>
        <td height="30">&nbsp;</td>
          <td colspan="2" valign="top"><label>Sample Tech Approval Id</label>&nbsp;</td>
          <td>&nbsp;</td>
          <td colspan="3" valign="top"><label>
      ...
      <tr>
        ...
        <td height="33">&nbsp;</td>
          <td colspan="2" valign="top"><label>Material Goodwill Id</label>&nbsp;</td>
          <td>&nbsp;</td>
          <td colspan="3" valign="top"><label>
            <select name="select2">
            </select>
      ...
      <tr>
        ...
        <td height="34">&nbsp;</td>
          <td colspan="2" valign="top"><label>Rating Id</label>
      ...
      <tr>
        <td height="33">&nbsp;</td>
          <td colspan="2" valign="top"><label>Sample Tech Approved</label>&nbsp;</td>
          <td>&nbsp;</td>
          <td colspan="3" valign="top"><label>
      ...
      <tr>
        <td height="31">&nbsp;</td>
        <td colspan="2" valign="top">Sample Tech Approved By</td>
          <td>&nbsp;</td>
          <td colspan="3" valign="top"><label>
      ...
      <tr>
        <td height="31">&nbsp;</td>
          <td colspan="2" valign="top"><label>Date On</label>
          &nbsp;</td>
          <td>&nbsp;</td>
          <td colspan="3" valign="top"><label>
