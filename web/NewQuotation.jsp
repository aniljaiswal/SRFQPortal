...
<body >
    <h:form action="abc1" onsubmit="validateNewQuotationBean(this);">
    <h:javascript formName="NewQuotationBean"/>
<table width="676" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="33"></td>
    <td></td>
    <td colspan="4" valign="top"><label><h1>New Quotation</h1></label>&nbsp;</td>
    <td></td>
  </tr>
  <tr>
    <td height="30">&nbsp;</td>
  ...
  <tr>
    ...
    <td colspan="2" valign="top">
        <select name="combMn">
            ...
            <core:forEach items="${sessionScope.it}" var="r">
             <option value="${r}">${r}</option>
            </core:forEach>
  ...
  <tr>
	...
	<core:forEach items="${sessionScope.uom}" var="r">
             <option value="${r}">${r}</option>
            </core:forEach>
            </select>&nbsp;</td>
    <td></td>
  ...
  <tr>
	...
	<core:forEach items="${sessionScope.cd}" var="r">
             <option value="${r}">${r}</option>
            </core:forEach>
	</select>&nbsp;</td>
    <td></td>
  ...
  <tr>
    <td height="31"></td>
    <td>&nbsp;</td>
    <td colspan="2" valign="top"><label><input type="submit" name="button1" value="Submit"  />
    </label></td>
    <td>&nbsp;</td>
    <td></td>
    <td></td>
