...
<html>
  ...
  <tr>
    ...
    <td valign="top"><table id="admtab" width="100%" border="0" cellpadding="0" cellspacing="0">
      <!--DWLayoutTable-->
      <tr>
        <td id="heading_econf" height="69" colspan="8" valign="top"><h2>Technical Feedback on Quotations</h2></td>
        </tr>
      <tr>
      ...
      <tr>
        <td height="31"></td>
          <td colspan="2" valign="top"><label>Technical Feedback Id</label>&nbsp;</td>
          <td>&nbsp;</td>
      ...
      <tr>
        <td height="30">&nbsp;</td>
          <td colspan="2" valign="top"><label>Material Goodwill</label></td>
          <td>&nbsp;</td>
          <td colspan="3" valign="top"><label>
            <select name="select">
            </select>
 ...
 <tr>
        <td height="30">&nbsp;</td>
          <td colspan="2" valign="top"><label>Rating Id</label>&nbsp;</td>
          <td>&nbsp;</td>
          <td colspan="3" valign="top"><label>
            <input type="text" name="textfield2" />
          </label></td>
