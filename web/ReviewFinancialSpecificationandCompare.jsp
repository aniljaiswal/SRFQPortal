...
<html>
    ...
    <body>
        <form action="ReviewFinancialSpecificationandCompare1.jsp">
  ...
  <tr>
    ...
    <td valign="top"><table id="admtab" width="100%" border="0" cellpadding="0" cellspacing="0">
      <!--DWLayoutTable-->
      <tr>
        <td id="heading_econf" height="69" colspan="8" valign="top"><h2>Review Financial Specification And Compare</h2></td>
        </tr>
      <tr>
      ...
      <tr>
        <td height="60">&nbsp;</td>
          ...
          <td colspan="3" valign="top">
                 ...
                 <label>
                  <input name="Submit" type="submit" id="Submit" value="Review And Compare" />
