 ...
 * @author kunal
 */
public class add_new_requestbean extends org.apache.struts.action.ActionForm {
    private String requirementPriorityMaster;
    private String materialMaster;
    private String unitMeasureMaster;
    private String quantity;
    private String reqPostingOpeningDate;
    private String reqPostingClosingDate;
    ...
    /**
     * @param RPriorityId the RPriorityId to set
     */
     ...
     * @return the reqPostingOpeningDate
     */
    public String getReqPostingOpeningDate() {
     ...
     */
    public void setReqPostingOpeningDate(String reqPostingOpeningDate) {
     ...
     */
    public String getReqPostingClosingDate() {
     ...
     * @param reqPostingClosingDate the reqPostingClosingDate to set
     */
    public void setReqPostingClosingDate(String reqPostingClosingDate) {
